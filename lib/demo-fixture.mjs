...
function buildDemoFlow(overrides) {
  ...
  return [
    ...
    },
    {
      ...
      event: `POS stores ${manifest.privateReport.encryptedReportHash.slice(0, 10)}...${manifest.privateReport.encryptedReportHash.slice(-8)} without publishing gross sales.`,
      tone: "good"
    },
    {
      key: "ctx-settlement",
