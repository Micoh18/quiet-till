  ...
  return {
    ...
    segments: [
      ...
      },
      {
        ...
        action: "Open the auditor proof, show the authorization panel, and show the tamper check.",
        narration:
          "The authorized auditor can inspect sales, formula, repayment, and outstanding, while a public observer cannot open the receipt. A one-unit sales tamper produces a different hash."
      },
      {
        startsAt: "2:40",
        endsAt: "3:00",
    ...
    submissionChecklist: {
      ...
      auditorDisclosureAuthorized: judgeEvidence.passConditions.auditorDisclosureAuthorized,
