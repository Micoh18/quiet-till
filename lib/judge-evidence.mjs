...
import { buildAuditorReceiptExport } from "./auditor-receipt-export.mjs";
...
function buildJudgeEvidence(overrides) {
  ...
  const auditorReceiptExport = buildAuditorReceiptExport(overrides);
  ...
  return {
    ...
    auditorEvidence: {
      ...
      receiptExportHash: auditorReceiptExport.exportHash
    },
    ...
    passConditions: {
      ...
      auditorReceiptExportAvailable: typeof auditorReceiptExport.exportHash === "string",
